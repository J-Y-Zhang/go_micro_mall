...
type UserService interface {
	...
	//查询用户信息
	GetInfo(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*UserInfoResponse, error)
}
...
func (c *userService) GetInfo(ctx context.Context, in *UserInfoRequest, opts ...client.CallOption) (*UserInfoResponse, error) {
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		GetInfo(ctx context.Context, in *UserInfoRequest, out *UserInfoResponse) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) GetInfo(ctx context.Context, in *UserInfoRequest, out *UserInfoResponse) error {
